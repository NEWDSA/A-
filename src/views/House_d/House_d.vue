  ...
  <div id="house_d">
    ...
    <van-popup v-model="show">
      <div id="popup">
          ...
          <span>蔡小姐(業主)</span>
          <article>
             <div> <img style="width:12px;margin-right:1px" src="/icon/tel_red_icon.png" alt=""> 手機正常撥</div>
             <div><img style="width:12px;margin-right:1px" src="/icon/tel_blue_icon.png" alt=""> 手機加撥0</div>
          </article>

            <article>
             <div><img style="width:12px;margin-right:3px" src="/icon/tel_red_icon.png" alt=""> 座機正常撥</div>
             <div><img style="width:12px;margin-right:3px" src="/icon/tel_blue_icon.png" alt="">座機加撥0</div>
          </article>
