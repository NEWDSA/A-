...
<!-- <van-card
    ...
    >
      <template #title>
            <van-tag plain type="danger" style="opacity:0.4">暫緩</van-tag>
         <span style="font-size: 15px;font-weight:700">泉裕豪庭5A</span>

         <div style="font-size:14px;padding: 8px;color:#666666">4-2-3-2 | 东北 | 1,385 呎</div>
         <span style="background-color:#f3e9fc;color:#b77af0;padding:3px 0px 5px">經理推薦</span>
         <span style="background-color:#f3e9fc;margin-left:5px;color:#b77af0;padding:3px">連租盤</span>
...
<van-card
    ...
    >
      <template #title>
            <van-tag plain type="danger" style="opacity:0.4">已租</van-tag>
         <span style="font-size: 15px;font-weight:700">泉裕豪庭5A</span>

         <div style="font-size:14px;padding: 4px;color:#666666">4-2-3-2 | 东北 | 1,385 呎</div>
         <span style="background-color:#f3e9fc;color:#b77af0;padding:3px 0px 5px">經理推薦</span>
         <span style="background-color:#f3e9fc;margin-left:5px;color:#b77af0;padding:3px">連租盤</span>
