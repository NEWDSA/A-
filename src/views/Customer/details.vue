<template>
  <div class="customer-detail">
    ...
    <van-card v-for="(item, index) in customer.Contacts"
          :key="index">
      <template #title>
        <div
        ...
        >
          <div style="width: 40%; margin-left: 20px">
            ...
            >
              ...
              >
                <img
                  style="width: 70px"
                  src="@/assets/icon/woman_vip_pictur.png"
                />
              </template>
              <template
                v-else-if="
              ...
              <template v-else-if="item.Gender == '先生' && customer.IsVip">
                <img
                  style="width: 65px"
                  src="@/assets/icon/man_vip_pictur.png"
                />
              </template>
              <template v-else>
                <img
            ...
            <div style="width: 100%" v-if="customer.Flag">
              <span style="color: #de4135">有效</span>
            </div>
          </div>
          ...
          <div style="margin-left: 5px; width: 40%">
            <div
              ...
              "
            >
              <div style="padding-right: 5px">手機:</div>
              <div class="lc_phone" v-if="item.Mobile">
                <van-icon name="phone" size="14" color="#ffffff" />
                {{ item.Mobile }}
              </div>
            </div>
            <div
              ...
              "
            >
              <div style="padding-right: 5px">座機:</div>
              <div class="lc_phone" v-if="item.Tel">
                {{ item.Tel }}
              </div>
            </div>
    ...
    <div style="background: #ffffff;margin-top:16px;">
