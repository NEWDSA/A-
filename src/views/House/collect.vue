  ...
  <div style="background: #ffffff">
    ...
    <van-dropdown-menu class="lc_str" :close-on-click-outside="false">
      <van-dropdown-item @open="show_area" title="區域" ref="lc_item">
        ...
        <div class="sort_btn">
          <div class="btn">
            <van-button @click="reset_area" type="warning" class="btn_reset">重置</van-button>
            <van-button class="btn_confrim" type="danger" @click="area_confrim_click">確定</van-button>
          </div>
        </div>
      </van-dropdown-item>
      <van-dropdown-item title="價格" ref="lc_item_price">
        ...
        <div class="sort_btn">
          <div class="btn">
            <van-button @click="price_reset()" type="warning" class="btn_reset">重置</van-button>
            <van-button class="btn_confrim" type="danger" @click="price_confirm_click">確定</van-button>
          </div>
        </div>
      </van-dropdown-item>
      <van-dropdown-item title="標簽" @open="show_tag" ref="lc_items_tags">
        ...
        <div class="lc_sort_btn">
          <div class="btn">
            ...
            <van-button type="danger" class="btn_confrim" @click="sure">確定</van-button>
          </div>
        </div>
      </van-dropdown-item>
      <van-dropdown-item @open="show_more" title="更多" ref="item">
        ...
        >
          <template #content>
            ...
            <!-- lc_Orientation -->
            <span v-show="lc_Orientation" class="lc_status_txt lc_staus_orientation">朝向</span>
            ...
            <div class="lc_field">
              <van-field v-model="lc_area_max" placeholder="请输入" size="mini" />
            </div>
            ...
            <div class="lc_field">
              <van-field v-model="lc_floor_min" placeholder="請輸入起始樓層" size="mini" />
            </div>
            <div class="lc_field">
              <van-field v-model="lc_floor_max" placeholder="請輸入結尾樓層" size="mini" />
            </div>
            <!-- 樓齡 -->
        ...
        <div class="sort_btn">
          <div class="btn">
            <van-button @click="more_rest()" type="warning" class="btn_reset">重置</van-button>
            <van-button type="danger" class="btn_confrim" @click="more">確定</van-button>
          </div>
        </div>
      </van-dropdown-item>
      <!-- 排序 -->
      <van-dropdown-item style="overflow: hidden" class="lc_rr" ref="sort_item">
        ...
        <van-cell-group>
          ...
          <div id="sort_btn" class="sort_btn" ref="lc_sort">
            <div class="btn">
              <van-button type="warning" class="btn_reset" @click="reset_sort">重置</van-button>
              <van-button class="btn_confrim" type="danger" @click="sort_click">確定</van-button>
            </div>
          </div>
        </van-cell-group>
      </van-dropdown-item>
      ...
      >
        ...
        >
          <template #title>
            ...
            <div
              style="font-size: 12px; padding: 5px; color: #666666"
            >{{ item.Floor }} {{ item.HouseType }}|{{ item.Square }}</div>
            <!-- 判斷推薦人是否為空  -->
            <template v-if="item.PropertyTags && item.PropertyTags.length > 0">
              <span
                style="background-color: #f3e9fc; color: #b77af0"
              >{{ item.PropertyTags.TagName }}</span>
            </template>
            <!-- end 判斷推薦人是否為空 -->
            <span
              style="
    ...
    <!-- 弹窗选择类型 -->
    <van-popup position="bottom" :style="{ height: '70%', overflow: 'hidden' }" v-model="show_type">
      <van-picker
        show-toolbar
        title="請選擇類型"
